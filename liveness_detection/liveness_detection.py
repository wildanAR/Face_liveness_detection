import random , cv2, imutils, liveness_detector
...
for i_questions in range(0,limit_questions):
    ...
    question = liveness_detector.question_bank(index_question)
    ...
    for i_try in range(limit_try):
        ...
        # <----------------------- ingestar data 
        TOTAL_0 = TOTAL
        out_model,leftEye = liveness_detector.detect_liveness(im,COUNTER,TOTAL_0)
        ...
        challenge_res = liveness_detector.challenge_result(question, out_model,blinks_up)
